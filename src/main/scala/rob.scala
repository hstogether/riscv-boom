            ...
            )(implicit p: Parameters)  extends BoomBundle()(p)
{
   ...
   val wb_resps = Vec(num_wakeup_ports, Valid(new ExeUnitResp(xLen max hfLen+hfLen/16))).flip
...
/*
         if( io.wb_resps(i).bits.uop.fu_code_is(UInt(0))==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 0)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_ALU)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 1)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_BRU)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 2)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_MEM)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 3)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_MUL)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 4)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_DIV)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 5)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_CSR)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 6)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_FPU)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 7)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_FDV)==true )
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 8)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_HFPU)==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 11)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_HFDV)==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 12)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_I2F )==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 9)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_F2I )==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 10)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_I2HF)==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 13)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_F2HF)==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 14)
         else if(io.wb_resps(i).bits.uop.fu_code_is(FUConstants.FU_HF2I)==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 15)
         else if(io.wb_resps(i).bits.uop.fu_code_is( FUConstants.FU_HF2F)==true)
          assert (!(io.wb_resps(i).valid && MatchBank(GetBankIdx(rob_idx)) && !rob_val(GetRowIdx(rob_idx))), "[ROB] writeback (" + i + ") occurred to an invalid ROB entry." + 16)
*/
